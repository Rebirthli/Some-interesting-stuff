...
client = OpenAI(
    api_key=api_key,
    base_url="https://dashscope.aliyuncs.com/compatible-mode/v1"  # Qwen API的基础URL
)
...
class QwenPerformanceTester:
    ...
    def save_results(self):
        ...
        filename = os.path.join(self.output_dir, f"qwen_performance_test_{timestamp}.json")
...
def main():
    parser = argparse.ArgumentParser(description='Qwen模型性能测试工具')
    ...
    parser.add_argument('--output-dir', type=str, default='Qwen-results', 
                        help='结果输出目录')
